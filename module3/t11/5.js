...
picArray.forEach((picture) => {
  ...
  headingElement.textContent = picture.title

  const figureElement = document.createElement("figure")

  const imgElement = document.createElement("img")
  imgElement.src = picture.image.medium;
  imgElement.alt = picture.title

  const figureCaptionElement = document.createElement("figcaption")
  figureElement.textContent = picture.caption
  ...
  articleElement.appendChild(descriptionElement);
   ...
   articleElement.addEventListener('click', () => {
    modalImage.src = picture.image.large;
